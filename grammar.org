...
** 分词做后置定语
   ...
   *when customers thumb through their phone directories/当客户用大拇指翻自己当电话本时/[]*.
   ...
   时间状语
** 分词做状语
   Arguing from the view that humans are different from animals in every relevant respect, extremists
   of this kind think that animals lie outside the area of moral choice.
 
   Feeling threatened, companies responded by writing everlonger warning labels, trying to anticipate
